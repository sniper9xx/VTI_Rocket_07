...
public class dateFormat {
	...
	public static void main(String[] args) {
		...
		System.out.println("Title : "+ex1.CategoryID.CategoryID);
		System.out.printf("CreateDate : %1$td - %1$tm - %1$tY ",ex1.CreateDate, ex1.CreateDate, ex1.CreateDate);
		System.out.println("\n");
		
		// Question 2:
		System.out.println("Câu 2");
		Exam ex[] = {ex1, ex2, ex3, ex4, ex5};
		for (int i = 0; i < ex.length ; i++){
			System.out.println("Thông tin của Exam thứ " + (i +1) +"là: ");
			System.out.printf("CreateDate : %1$td - %1$tm - %1$tY %tH : %tM : %tS",ex[i].CreateDate, ex[i].CreateDate, ex[i].CreateDate, ex[i].CreateDate);
			System.out.println("\n");
		}
		
		//Question 3:
		System.out.println("Câu 3");
		System.out.println("Thông tin năm của Question thứ 2 là: ");
		System.out.printf("Year : %tY ", ques2.CreateDate);
		System.out.println("\n");
		
		//Question 4:
		System.out.println("Câu 4");
		System.out.println("Thông tin tháng năm của Question thứ 2 là: ");
		System.out.printf("Month - Year : %1$tm - %1$tY ", ques2.CreateDate);
		System.out.println("\n");
		
		////Question 5:
		System.out.println("Câu 5");
		System.out.println("Thông tin tháng ngày của Question thứ 2 là: ");
		System.out.printf("Month - Day : %1$tm - %1$td", ques2.CreateDate);
		System.out.println("\n");
